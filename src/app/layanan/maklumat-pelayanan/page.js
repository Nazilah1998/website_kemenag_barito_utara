...
export const metadata = {
  title: "Maklumat Pelayanan | Kementerian Agama Kabupaten Barito Utara",
};

export default function MaklumatPelayananPage() {
  const pageTitle = "Maklumat Pelayanan Sedang Diperbarui";
  const menuName = "Maklumat Pelayanan";
