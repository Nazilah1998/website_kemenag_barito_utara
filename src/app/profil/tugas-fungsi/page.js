export const metadata = {
  title: "Tugas dan Fungsi | Kementerian Agama Kabupaten Barito Utara",
  description:
    "Tugas dan fungsi Kementerian Agama Kabupaten Barito Utara dalam pelayanan keagamaan, pendidikan, pembinaan umat, dan tata kelola kelembagaan.",
};
        ...
        <div className="relative w-full px-6 py-20 sm:px-10 lg:px-16 xl:px-20">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-3xl text-base leading-8 text-emerald-50 md:text-lg">
              Kementerian Agama Kabupaten Barito Utara melaksanakan pelayanan,
              pembinaan, koordinasi, dan tata kelola urusan keagamaan secara
              profesional, berintegritas, dan berorientasi pada kepentingan
              masyarakat.
            </p>
          </div>
        </div>
      ...
      <section className="relative -mt-10 w-full px-6 pb-20 sm:px-10 lg:px-16 xl:px-20">
        <div className="grid gap-4 md:grid-cols-4">
          {indikator.map((item) => (
            <div
              key={item}
              className="rounded-3xl border border-white/70 bg-white p-6 text-center shadow-xl"
            >
              <p className="text-lg font-black text-emerald-800">{item}</p>
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-4xlrder border-slate-200 bg-white p-8 shadow-sm">
            ...
            <div className="mt-8 space-y-5">
              {tugasUtama.map((item, index) => (
                <div key={item} className="flex gap-4">
                  ...
                  <p className="text-sm leading-8 text-slate-600">{item}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mt-10">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {fungsiLayanan.map((item) => (
              <div
                key={item.title}
                className="group rounded-[1.7rem] border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:border-emerald-200 hover:shadow-xl"
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-100 text-emerald-800 transition group-hover:bg-emerald-700 group-hover:text-white">
                  <CheckIcon />
                </div>
        ...
        <div className="mt-12 rounded-4xl bg-linear-to-r from-emerald-700 to-teal-700 p-8 text-white shadow-xl">
          <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
            ...
            <div className="rounded-2xl bg-white px-6 py-4 text-center text-emerald-800 shadow-lg">
