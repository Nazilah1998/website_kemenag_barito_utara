export const leadershipMessage = {
  ...
  message: [
    ...
    "Melalui website ini, kami berharap masyarakat dapat memperoleh informasi yang akurat, layanan yang jelas, serta akses yang lebih dekat terhadap berbagai program dan kegiatan Kementerian Agama di Kabupaten Barito Utara.",
  ],
};