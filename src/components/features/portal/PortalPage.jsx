  ...
  return (
    <div className="relative h-screen flex flex-col items-center justify-center overflow-hidden bg-slate-900 selection:bg-emerald-500/30">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="hidden md:flex relative z-10 w-full px-6 lg:px-10 xl:px-16 pt-8 pb-4 flex-col items-center h-full overflow-hidden"
      >
        {/* Logo & Title Section */}
        <motion.div variants={headerVariants} className="flex flex-col items-center text-center mb-4">
          <div className="w-20 h-20 mb-4 relative bg-white/10 backdrop-blur-md p-3 rounded-2xl ring-1 ring-white/20 shadow-2xl transition-transform hover:scale-105 duration-500">
            <Image src={siteInfo.logoSrc} alt="Logo" width={56} height={56} className="w-full h-full object-contain drop-shadow-lg" unoptimized />
          </div>
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="flex md:hidden relative z-10 w-full px-5 pt-8 pb-6 flex-col items-center h-full overflow-hidden"
      >
        {/* Logo & Title Section */}
        <motion.div variants={headerVariants} className="flex flex-col items-center text-center mb-6">
          ...
          <p className="mt-4 text-slate-400 text-[10px] font-medium px-2 leading-relaxed">
            Akses cepat informasi dan layanan keagamaan Kabupaten Barito Utara dalam satu pintu.
          </p>
        </motion.div>

        {/* Enhanced Status & Time - Mobile (Above Grid) */}
        <motion.div variants={headerVariants} className="flex flex-col items-center bg-white/5 backdrop-blur-lg px-4 py-2.5 rounded-2xl ring-1 ring-white/10 mb-6 w-full">
