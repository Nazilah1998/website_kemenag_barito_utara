  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...
        {
          role: "assistant",
          content: "Maaf, koneksi terganggu. Silakan coba lagi atau hubungi kami via WhatsApp.",
          time: new Date(),
        },
      ]);
    } finally {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        onMouseLeave={(e) => { e.currentTarget.style.transform = "scale(1)"; e.currentTarget.style.animation = "pulseGreen 2.5s ease-in-out infinite"; }}
      >
        <IconMessage />
        <span style={{
        ...
        <style>{`@keyframes pulseGreen { 0%,100%{box-shadow:0 4px 24px rgba(5,150,105,0.45),0 2px 8px rgba(0,0,0,0.2)}50%{box-shadow:0 4px 32px rgba(5,150,105,0.7),0 2px 12px rgba(0,0,0,0.25)} }`}</style>
      </button>
    );
  }
  ...
  return (
    ...
    >
          ...
          <div style={{ display:"flex", alignItems:"center", gap:12 }}>
            ...
            <div>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:5, marginTop:3 }}>
                <span style={{ width:7, height:7, background:"#86efac", borderRadius:"50%", display:"inline-block", boxShadow:"0 0 6px #86efac" }} />
                <span style={{ color:"rgba(255,255,255,0.75)", fontSize:11.5, fontWeight:500 }}>Online • Siap Membantu</span>
              </div>
            </div>
          </div>
          {/* Action buttons */}
      ...
      <div style={{
        ...
        {messages.map((msg, i) => (
          ...
          >
            ...
            <span style={{ fontSize:10.5, color:"rgba(255,255,255,0.3)", marginTop:4, paddingLeft:4, paddingRight:4 }}>
              {formatTime(msg.time)}
            </span>
          </div>
        ))}
        ...
        {/* Typing Indicator */}
        {isLoading && (
          <div style={{ display:"flex", alignItems:"flex-start", gap:8, animation:"fadeSlideIn 0.3s ease" }}>
            <div style={{
        ...
        {showQuickActions && messages.length === 1 && (
          <div style={{ animation:"fadeSlideIn 0.4s ease 0.2s both" }}>
            <p style={{ fontSize:11.5, color:"rgba(255,255,255,0.35)", marginBottom:8, paddingLeft:2 }}>Pertanyaan Populer:</p>
      ...
      <div style={{
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              boxShadow: input.trim() && !isLoading ? "0 2px 12px rgba(5,150,105,0.4)" : "none",
            }}
          >
            <IconSend />
          </button>
        ...
        <p style={{ textAlign:"center", fontSize:10, color:"rgba(255,255,255,0.18)", marginTop:8, letterSpacing:"0.3px" }}>
          Didukung Google Gemini AI · Kemenag Barito Utara
        </p>
      </div>
