...
export default function AdminLogoutButton() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="group relative flex h-12 w-full items-center justify-center overflow-hidden rounded-xl bg-slate-900 text-[10px] font-black uppercase tracking-[0.25em] text-white transition-all hover:bg-black disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400 dark:bg-white dark:text-black dark:hover:bg-slate-200"
    >
